      ...
      <div className="flex max-w-[80vw] flex-col  items-center">
        <div className="my-1.5 flex flex-row flex-wrap justify-center ">
          <select
            ...
            className="max-w-xs max-w-xs select-bordered  select select-xs my-[1.5em] w-[250px] bg-card"
          >
        ...
        <div className="form-control  flex w-full justify-center">
          ...
          <input
            ...
            className="focus-input max-w-xs input-bordered input my-[1.5em] w-full bg-card"
          />
          <ul>
            {searchError &&
